...
import logo from './img/chef_icon.jpg';
import './saved.css';
...
export default class saved extends Component {
    ...
    sortRecipe(order) {
        console.log('sortingRecipes',this.state.savedRecipes)
    ...
    render() {
                ...
                <div className='recipeCard' key={i}>
                    ...
                    <div className='RecipeLower'>
                        ...
                        <div className='Content'>
                            ...
                            <button className='Delete' onClick={(e) => this.deleteRecipe(recipe.id)}>Delete</button>
                        </div>
        ...
        return (
            <div className='Container'>
                <div className="App-header saved-header">
